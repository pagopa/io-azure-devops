variable "tlscert-prod-weuprod01-profile-internal-io-pagopa-it" {
  default = {
    repository = {
      organization   = "pagopa"
    ...
    pipeline = {
      ...
      dns_record_name = "weuprod01.profile.internal"
...
locals {
  ...
  tlscert-prod-weuprod01-profile-internal-io-pagopa-it-variables = {
  ...
  tlscert-prod-weuprod01-profile-internal-io-pagopa-it-variables_secret = {
  }
}
...
module "tlscert-prod-weuprod01-profile-internal-io-pagopa-it-cert_az" {
  ...
  variables = merge(
    var.tlscert-prod-weuprod01-profile-internal-io-pagopa-it.pipeline.variables,
    local.tlscert-prod-weuprod01-profile-internal-io-pagopa-it-variables,
  )

  variables_secret = merge(
    var.tlscert-prod-weuprod01-profile-internal-io-pagopa-it.pipeline.variables_secret,
    local.tlscert-prod-weuprod01-profile-internal-io-pagopa-it-variables_secret,
  )
