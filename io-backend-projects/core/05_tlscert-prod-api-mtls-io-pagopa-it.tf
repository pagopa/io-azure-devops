...
module "tlscert-prod-api-mtls-io-pagopa-it-cert_az" {
  ...
  path                         = "${local.domain}\\${var.tlscert-prod-api-mtls-io-pagopa-it.pipeline.path}"
  ...
  dns_zone_resource_group              = local.tlscert-prod-api-mtls-io-pagopa-it.dns_zone_resource_group
  ...
  credential_key_vault_name           = local.tlscert-prod-api-mtls-io-pagopa-it.credential_key_vault_name
  credential_key_vault_resource_group = local.tlscert-prod-api-mtls-io-pagopa-it.credential_key_vault_resource_group
  ...
  service_connection_ids_authorization = local.tlscert-prod-api-mtls-io-pagopa-it.service_connection_ids_authorization
