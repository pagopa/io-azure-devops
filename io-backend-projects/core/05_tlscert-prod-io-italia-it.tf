...
module "tlscert-prod-io-italia-it-cert_az" {
  ...
  path                         = "${local.domain}\\${var.tlscert-prod-io-italia-it.pipeline.path}"
  ...
  dns_zone_resource_group              = local.tlscert-prod-io-italia-it.dns_zone_resource_group
  ...
  credential_key_vault_name           = local.tlscert-prod-io-italia-it.credential_key_vault_name
  credential_key_vault_resource_group = local.tlscert-prod-io-italia-it.credential_key_vault_resource_group
  ...
  service_connection_ids_authorization = local.tlscert-prod-io-italia-it.service_connection_ids_authorization
