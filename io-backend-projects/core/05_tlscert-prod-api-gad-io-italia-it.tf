...
module "tlscert-prod-api-gad-io-italia-it-cert_az" {
  ...
  dns_zone_resource_group              = local.tlscert-prod-api-gad-io-italia-it.dns_zone_resource_group
  ...
  credential_key_vault_name           = local.tlscert-prod-api-gad-io-italia-it.credential_key_vault_name
  credential_key_vault_resource_group = local.tlscert-prod-api-gad-io-italia-it.credential_key_vault_resource_group
