...
locals {
  ...
  profile-iac-variables = {
    tf_beta_aks_apiserver_url           = module.profile_prod_secrets.values["io-p-weu-beta-aks-apiserver-url"].value,
    tf_beta_aks_azure_devops_sa_cacrt   = module.profile_prod_secrets.values["io-p-weu-beta-aks-azure-devops-sa-cacrt"].value,
    tf_beta_aks_azure_devops_sa_token   = base64decode(module.profile_prod_secrets.values["io-p-weu-beta-aks-azure-devops-sa-token"].value),
