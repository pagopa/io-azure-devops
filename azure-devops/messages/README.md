...
|------|-------------|------|---------|:--------:|
| <a name="input_io-functions-service-messages"></a> [io-functions-service-messages](#input\_io-functions-service-messages) | n/a | `map` | <pre>{<br>  "pipeline": {<br>    "enable_code_review": true,<br>    "enable_deploy": true<br>  },<br>  "repository": {<br>    "branch_name": "master",<br>    "name": "io-functions-service-messages",<br>    "organization": "pagopa",<br>    "pipelines_path": ".devops",<br>    "yml_prefix_name": null<br>  }<br>}</pre> | no |
