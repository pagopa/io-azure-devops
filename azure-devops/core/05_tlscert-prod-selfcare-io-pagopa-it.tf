...
module "tlscert-prod-selfcare-io-pagopa-it-cert_az" {
  ...
  name       = "${var.tlscert-prod-selfcare-io-pagopa-it.pipeline.dns_record_name}.${var.tlscert-prod-selfcare-io-pagopa-it.pipeline.dns_zone_name}"
  #tfsec:ignore:general-secrets-no-plaintext-exposure
  #tfsec:ignore:GEN003
  ...
  credential_subcription              = local.tlscert-prod-selfcare-io-pagopa-it.credential_subcription
